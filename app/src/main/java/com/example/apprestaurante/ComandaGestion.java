...
public class ComandaGestion extends AppCompatActivity implements  PedidosAdapter.OnItemClickListener {
                ...
                for (final Cliente client : lstClientes) {
                    ...
                    button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Toast.makeText(ComandaGestion.this, "Cliente: " + client.getNombre() + " Seleccionado", Toast.LENGTH_SHORT).show();

                            Pedido pedCliente = new Pedido();
                            //Guardar en la base de datos ActualizarCliente
                            if (pedCliente != null) {
                                pedCliente.setIdPedido(idPedido);
                                pedCliente.setIdMesa(idMesa);
                                pedCliente.setIdCliente(Integer.parseInt(tag));
                                ActualizarCliente(pedCliente, tag);
                            }else{
    ...
    private void ActualizarCliente(Pedido pedido, String tag) {
        PedidoService pedidoService = new PedidoService();
        pedidoService.ActualizarCliente(pedido, new CallBackApi<Boolean>() {
            @Override
